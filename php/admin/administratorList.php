...
<body class="page-header-fixed">
	...
	<?require_once("head.php");?>
						...
						<h3 class="page-title">
							...
							管理员列表 <small>Administrator list</small>
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
									...
									<tbody>
										<?php
									$sql->query("select * from admin {$sql_add_admin}");
									...
									?>
										<tr>
											...
											<td ><? $row['admin_status'] == 1 ?print "启用":print "停用";?></td>
											<td class="hidden-480">	
									<form action='action/deleteOpp.php' style="padding:0;margin:0" method="POST">	
									<button type="button" onclick='edit("administratorEdit.php?id=<?= $row['id']?>")' class="btn yellow mini" ><i class=" icon-edit icon-white"></i></button>
									<input type="hidden" value="<?= $row['id']?>" name="id">
									<input type="hidden" value="admin" name="db">
