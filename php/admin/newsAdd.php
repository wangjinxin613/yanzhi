					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>添加资讯</div>
							...
							<div class="portlet-body form">
								...
								<form action="action/newsAdd.php" class="form-horizontal" method="post"  enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="checkbox" value="1" name="type"/> 轮播图

											</label>

											<label class="checkbox">

											<input type="checkbox" value="2" name="type"/> 推荐
									...
									<div class="control-group">
												...
												<div class="controls">
													...
													<input type="text" class="span3 m-wrap" name="source"/>

													<span class="help-inline">
													<label style="margin-left:40PX;">作者</label>

													</span><input type="text" class="span3 m-wrap" style="margin-left:15px;" name="writer"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<textarea class="span12 wysihtml5 m-wrap" rows="15" name="body"></textarea>
