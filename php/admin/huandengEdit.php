<?php
	...
	$id = $_GET['id'];
	$sql->query("select * from lunbo where id = '$id'");
	$row = $sql->fetch_assoc();
?>
<!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<form action="action/huandengEdit.php" class="form-horizontal" method="post"  enctype="multipart/form-data">
								<input type="hidden" value="<?= $row['id']?>" name="id">
									...
									<div class="control-group">
												...
												<div class="controls">
													...
													<input type="text"  name="web_url" value="<?= $row['web_url']?>"/>
