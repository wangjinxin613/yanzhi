					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>打赏记录</div>
							...
							<div class="portlet-body">
								...
								<table class="table table-bordered table-striped table-bordered table-hover table-full-width" id="sample_2">
									...
									<tbody>
										<?php
									$sql->query("select * from reward_order where status = '1' order by id desc");
									...
									?>
										<tr>
											...
											<td ><img src="<? 
												...
												echo $result['imgurl'];
										?>" style="width:80px;" onclick='edit("detail.php?id=<?= $row['lid']?>")'></td>
	<td><?= $row['lid']?></td>
											<td><?= $row['nickName']?></td>
											<td><?= $row['money']?></td>
