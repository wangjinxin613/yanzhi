<?php
	...
	foreach ($_POST['item'] as $key => $value) {
		...
		$h = $h.'<iframe src="../pdf_sheng/district_'.$value.'.html"  frameborder="0" scroll="no"></iframe><div class="page"></div>';
	}
	  ob_start();
	$html = '<html>
<head>
...
$filename = "test";
        ...
        //convert HTML to PDF
        shell_exec("wkhtmltopdf --javascript-delay 1000 --page-height 211 {$filename}.html {$filename}.pdf");
