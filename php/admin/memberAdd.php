...
<span class="help-inline" style="margin-left:170px;">您只能选择<?= $admin->areaName?>以内的区域,包括<?= $admin->areaName?>,一经选择不可修改</span>
								...
								<div class="form-actions clearfix" style="padding-left:150px;">		
											<button href="javascript:;" type="button" class="btn green button-submit" onclick="showAreaID()">提交 <i class="m-icon-swapright m-icon-white"></i></button>
								</div>	
