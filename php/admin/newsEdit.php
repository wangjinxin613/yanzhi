<?php
	...
	$id = $_GET['id'];
	$sql->query("select * from news where id = '$id'");
	$row = $sql->fetch_assoc();
?>
<!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>编辑资讯</div>
							...
							<div class="portlet-body form">
								...
								<form action="action/newsEdit.php" class="form-horizontal" method="post"  enctype="multipart/form-data">
								<input type="hidden" value="<?= $row['id']?>" name="id">
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6 m-wrap" name="title" value="<?= $row['title']?>"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="checkbox" value="1" name="type" checked='true' <? if($row['type'] == 1){ echo "checked='true'";}?>/> 轮播图

											</label>

											<label class="checkbox">

											<input type="checkbox" value="2" name="type" <? if($row['type'] == 2){ echo "checked='true'";}?>/> 推荐
									...
									<div class="control-group">
												...
												<div class="controls">
													...
													<input type="text" class="span3 m-wrap" name="source" value="<?= $row['source']?>"/>

													<span class="help-inline">
													<label style="margin-left:40PX;">作者</label>

													</span><input type="text" class="span3 m-wrap" style="margin-left:15px;" name="writer" value="<?= $row['writer']?>"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<textarea class="span12 wysihtml5 m-wrap" rows="15" name="body"><?= $row['body']?></textarea>
