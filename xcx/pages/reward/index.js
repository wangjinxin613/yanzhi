		...
		app.connect("rewardOrderForm.php",{
			...
			wx.request({
				...
				success: function (e) {
					...
					//小程序唤起支付
					var prepay_id = e.data.prepay_id;
					...
					wx.requestPayment({
						...
						success:function(e){
							...
							//发送模板消息通知
							console.log(prepay_id);
							if (that.data.userInfo.notice == 1) {
								app.connect("sendPost.php", {
									//openid: that.data.data_list.openid,
									openid: app.globalData.userInfo.openId,
									prepay_id: prepay_id,
									token: app.globalData.token,
									name: that.data.data_list.nickName,
									money: that.data.money
								}, function (e) {
									//console.log(e);
								});
								...
								wx.request({
									...
									data: {
										touser: that.data.data_list.openid,
										template_id: "2oaPlq0Bde9xFqLz-Pi_10opl6RVsNoLozDHd9ioK7A",
